<template>
  <div class="min-h-screen flex flex-col" :class="colorMode.value === 'dark' ? 'bg-gray-900' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'">
    ...
    <header class="fancy-header fixed left-0 w-full backdrop-blur-sm z-50 md:z-40 transition-all duration-300 global-header" :class="{ 'scrolled': isHeaderScrolled, 'dark-header': colorMode.value === 'dark' }" id="stickyHeader" :style="{ top: '32px', marginTop: 0, paddingTop: 0, borderTop: 'none', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }">
      ...
      <div v-show="showTopBars" class="hidden lg:block bg-gradient-to-r from-red-50 via-pink-50 to-emerald-50 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 py-0 relative">
        ...
        <div class="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-2 lg:gap-0">
          ...
          <div class="flex items-center justify-end gap-2 sm:gap-3 lg:gap-4 flex-wrap lg:flex-nowrap w-full lg:w-auto">
            <a
              ...
              class="text-sm text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition-all duration-300 hover:scale-105 font-black tracking-wide order-1"
              target="_blank"
            ...
            <span class="hidden xl:inline-block text-gray-600 dark:text-gray-400 font-black text-lg order-2">|</span>
            <div class="order-3 flex-shrink-0">
              <LanguageSwitcherComponent />
            </div>
            <span class="hidden xl:inline-block text-gray-600 dark:text-gray-400 font-black text-lg order-4">|</span>
            <div class="order-5 flex-shrink-0 w-full sm:w-auto">
              <DataSaverToggle />
            </div>
          </div>
        </div>
      ...
      <div :class="[
        ...
        showTopBars 
          ? colorMode.value === 'dark' 
            ? 'bg-gray-900 py-1 sm:py-2 md:py-3' 
            : 'bg-gradient-to-r from-blue-100 via-indigo-100 to-purple-100 py-1 sm:py-2 md:py-3'
          : colorMode.value === 'dark'
            ? 'bg-gray-900/95 py-1 sm:py-1.5 md:py-2'
            : 'bg-gradient-to-r from-blue-100/95 via-indigo-100/95 to-purple-100/95 py-1 sm:py-1.5 md:py-2'
      ]">
        <!-- Clean professional accent line -->
        <div class="absolute bottom-0 left-0 right-0 h-0.5 transition-all duration-300"
             :class="colorMode.value === 'dark' 
               ? 'bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 opacity-50'
               : 'bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 opacity-70'"></div>
        <div :class="['max-w-7xl mx-auto flex items-center justify-between flex-nowrap gap-2 sm:gap-3 md:gap-4', isBlogDetail ? 'px-2 sm:px-3 md:px-4 lg:px-6' : 'px-3 sm:px-4 md:px-6 lg:px-8']">
          ...
          <div class="flex items-center relative z-10 flex-shrink-0">
            <a href="/" aria-label="JasaPembayaran.com" class="block">
              <LogoPro
                :class="[
                  'h-12 sm:h-14 md:h-16 lg:h-18 xl:h-20 w-auto transition-all duration-300 hover:scale-110 filter drop-shadow-lg dark:drop-shadow-xl hover:drop-shadow-2xl',
                  colorMode.value === 'dark' ? 'brightness-0 invert' : 'brightness-0'
                ]"
              />
            </a>
          </div>
          ...
          <!-- Smart Slide Menu (visible when top bars hidden) -->
          <div v-show="!showTopBars" class="hidden lg:flex items-center shrink-0 whitespace-nowrap relative z-10">
            <!-- Simple Smart Menu Button -->
            <div class="relative">
              <button
                @click="toggleSmartMenu"
                class="flex items-center justify-center size-10 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110 relative overflow-hidden group"
                :class="[
                  { 'scale-105 shadow-2xl': showSmartMenu },
                  colorMode.value === 'dark' 
                    ? 'bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 border border-gray-600' 
                    : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300'
                ]"
              ...
              >
                ...
                <div class="relative w-6 h-6 flex flex-col justify-center items-center">
                  <span 
                    class="block w-5 h-0.5 transition-all duration-300 ease-in-out"
                    :class="[
                      { 'rotate-45 translate-y-1.5': showSmartMenu },
                      colorMode.value === 'dark' ? 'bg-gray-300' : 'bg-gray-700'
                    ]"
                  ></span>
                  <span 
                    class="block w-5 h-0.5 transition-all duration-300 ease-in-out mt-1"
                    :class="[
                      { 'opacity-0': showSmartMenu },
                      colorMode.value === 'dark' ? 'bg-gray-300' : 'bg-gray-700'
                    ]"
                  ></span>
                  <span 
              ...
              >
                <div
                  v-if="showSmartMenu"
                  class="absolute right-0 top-12 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50"
                  @click.stop
                >
                  <!-- Header -->
                  <div 
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <h3 
                        ...
                        :class="colorMode.value === 'dark' ? 'text-gray-200' : 'text-gray-800'"
                      >
                        Menu Pintar
                      </h3>
                      <button
                        @click="closeSmartMenu"
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="relative">
                        <input
                          ...
                          class="w-full px-4 py-3 pl-10 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
            ...
            <button
              @click="toggleColorMode"
                        class="w-full flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200"
                      >
                        <div class="flex items-center space-x-3">
                          <div class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">
                              {{ colorMode.value === 'dark' ? 'Mode Gelap' : 'Mode Terang' }}
                            </span>
                          </div>
                        </div>
                        <div class="relative w-12 h-6 rounded-full transition-colors duration-300"
                             :class="colorMode.value === 'dark' ? 'bg-indigo-500' : 'bg-gray-300'">
                          <div class="absolute top-1 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-300"
                               :class="colorMode.value === 'dark' ? 'translate-x-6' : 'translate-x-1'"></div>
                        </div>
            </button>
                    </div>
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="grid grid-cols-2 gap-3">
                        <button
                          @click="toggleLanguage('id'); closeSmartMenu()"
                        ...
                        <button
                          @click="toggleLanguage('en'); closeSmartMenu()"
                          class="flex items-center justify-center space-x-2 p-3 rounded-xl border transition-all duration-200"
                    ...
                    <div class="space-y-3">
                      <div class="flex items-center space-x-2 text-gray-700 dark:text-gray-300">
                        ...
                        <span class="font-semibold">Aksi Cepat</span>
                      </div>
            ...
            <!-- Compact Clock Time (text) + Popover -->
            <div class="relative hidden sm:block" ref="stickyClockRef" @mouseenter="onStickyClockEnter" @mouseleave="onStickyClockLeave" @focusin="onStickyClockEnter" @focusout="onStickyClockLeave" @touchstart.stop="onStickyClockEnter" @touchend="onStickyClockLeave">
              <button
                type="button"
                @click="toggleStickyClockPopover"
                class="flex items-center h-10 px-3 sm:px-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none"
                :class="colorMode.value === 'dark' 
                  ? 'bg-gradient-to-r from-gray-800 to-gray-700 hover:from-gray-700 hover:to-gray-600 border border-gray-600 text-gray-200' 
                  : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300 text-gray-800'"
                aria-label="Waktu Jakarta"
                title="Waktu"
              >
                <span class="whitespace-nowrap text-sm sm:text-base font-black tracking-wider">{{ currentTime }} WIB</span>
              </button>
              <Transition
              ...
              >
                <div
                  v-if="showStickyClockInfo"
                  id="sticky-clock-popover"
                  role="tooltip"
          ...
          <div v-show="showTopBars" class="hidden lg:flex items-center space-x-4 flex-nowrap relative z-10">
            ...
            <button
              @click="toggleColorMode"
              class="flex items-center justify-center size-10 rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-110 hover:rotate-12"
              :class="colorMode.value === 'dark' 
                ? 'bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 border border-gray-600' 
                : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300'"
            ...
            <div class="relative shrink-0" ref="desktopClockRef" @mouseenter="onDesktopClockEnter" @mouseleave="onDesktopClockLeave" @focusin="onDesktopClockEnter" @focusout="onDesktopClockLeave" @touchstart.stop="onDesktopClockEnter" @touchend="onDesktopClockLeave">
              <button
                ...
                class="group text-base font-black px-6 py-2.5 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center leading-none whitespace-nowrap focus:outline-none"
                :class="[
                  showDesktopClockInfo ? 'shadow-lg scale-105' : '',
                  colorMode.value === 'dark' 
                    ? 'bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 border border-gray-600 text-gray-200' 
                    : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300 text-gray-800'
                ]"
              ...
              >
                ...
                />
                <span class="transition-colors duration-200 font-black text-base tracking-wider">{{ currentTime }} WIB</span>
              </button>
              <Transition
                enter-active-class="transition ease-out duration-150"
                enter-from-class="opacity-0 translate-y-1 scale-95"
          ...
          <div class="lg:hidden flex items-center gap-2 sm:gap-3 relative shrink-0 z-10" ref="mobileClockRef">
            <button
              ...
              class="group text-xs sm:text-sm font-bold flex items-center px-2 py-1 sm:px-2.5 sm:py-1.5 md:px-3 md:py-2 rounded-md sm:rounded-lg md:rounded-xl shadow-lg hover:shadow-xl active:shadow-inner transition-all duration-300 focus:outline-none hover:scale-105"
              :class="[
                colorMode.value === 'dark' 
                  ? 'bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 border border-gray-600 text-gray-200' 
                  : 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300 text-gray-800',
                showMobileClockInfo ? 'shadow-lg scale-105' : ''
              ]"
            ...
            >
              <UIcon 
                name="i-lucide-clock" 
                class="size-3 sm:size-3.5 md:size-4 mr-1 sm:mr-1.5" 
                :class="colorMode.value === 'dark' ? 'text-gray-300' : 'text-gray-600'"
              />
              <span class="whitespace-nowrap font-bold text-xs sm:text-sm tracking-wide">{{ currentTime }} WIB</span>
            </button>
    ...
    <button
      ...
      class="focus:outline-none p-1.5 sm:p-2 md:p-2.5 rounded-full bg-black dark:bg-white text-white dark:text-black shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group border border-gray-600/70 dark:border-gray-300/80 cursor-pointer"
      aria-label="Menu"
      ...
      style="z-index: 1000;"
    >
      <span class="absolute inset-0 bg-white/10 dark:bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></span>
      <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 relative z-10 transition-all duration-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
      ...
      <Teleport to="body">
        <div
          v-if="toggleMobile"
          class="lg:hidden fixed inset-0 z-[9999] bg-black/70 backdrop-blur-md transition-all duration-300"
          @mousedown.self.stop="onCloseMobileMenu"
          @touchstart.self.stop="onCloseMobileMenu"
          @pointerdown.self.stop="onCloseMobileMenu"
          @click.self.stop.prevent="onCloseMobileMenu"
        >
        <div
          class="mobile-nav h-full w-[90%] sm:w-[85%] max-w-sm overflow-y-auto fixed top-0 right-0 shadow-2xl border-l border-indigo-500/40 animate-slide-in bg-white bg-gradient-to-b from-white via-slate-50 to-slate-100 dark:bg-slate-950 dark:bg-gradient-to-b dark:from-slate-950 dark:via-slate-900 dark:to-black"
        >
          <!-- Mobile menu header with close button -->
          <div
            class="flex items-center justify-between px-4 sm:px-6 py-4 mt-6 sm:mt-8 rounded-b-2xl shadow-sm border-b"
            :class="colorMode.value === 'dark'
              ? 'bg-slate-800 border-slate-600 shadow-indigo-900/40'
              : 'bg-gray-50/90 border-gray-200/80'"
          >
            <div class="flex items-center mr-6">
              <a
                href="/"
                aria-label="JasaPembayaran.com"
                :class="colorMode.value === 'dark'
                  ? 'inline-flex items-center px-3 py-1.5 rounded-xl bg-slate-700/90 shadow-lg'
                  : 'inline-flex items-center'"
              >
                <img
                  src="/logo-jasapembayaran.png"
                  alt="Logo"
                  class="h-12 sm:h-14 w-auto transition-all duration-300 hover:scale-110 hover:brightness-125 hover:contrast-150 hover:drop-shadow-2xl"
                  :class="colorMode.value === 'dark' ? 'brightness-0 invert' : 'brightness-0'"
                  loading="lazy"
                  decoding="async"
                  fetchpriority="low"
            ...
            <div class="flex items-center">
              <button
                ...
                class="focus:outline-none p-2.5 rounded-full bg-black dark:bg-white text-white dark:text-black shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group hover:scale-105 border border-gray-600/70 dark:border-gray-300/80">
                <span class="absolute inset-0 bg-white/10 dark:bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></span>
                <svg class="w-6 h-6 relative z-10 transition-all duration-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
            </div>
          ...
          <div class="px-4 py-4 border-b border-gray-200/80 dark:border-slate-800/80 bg-white/70 dark:bg-slate-950/60 backdrop-blur">
            <div class="relative">
              <input
                type="text"
                v-model="smartSearchQuery"
                placeholder="Cari artikel, kata kunci..."
                class="w-full px-4 py-3 pl-10 pr-24 bg-white/95 dark:bg-black border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                @keyup.enter="handleSmartSearch"
              />
              ...
              <button
                ...
                class="absolute inset-y-1 right-1 px-3 flex items-center gap-1 rounded-lg bg-black dark:bg-white text-white dark:text-black text-xs font-semibold shadow-md hover:shadow-lg transition-all duration-200"
              >
                <span>Cari</span>
          ...
          <div class="px-4 py-2 space-y-1">
            <NuxtLink
              to="/"
              @click="onCloseMobileMenu"
              class="mobile-link flex items-center py-4 border-b border-gray-200/70 dark:border-slate-800/80 hover:bg-orange-50/90 dark:hover:bg-gradient-to-r dark:hover:from-slate-800/80 dark:hover:to-slate-900/80 rounded-xl px-3 my-1 transition-all duration-300 group"
            >
            ...
            <!-- Settings Section -->
            <div class="px-4 py-4 border-t border-gray-200/80 dark:border-slate-800/80 mt-4">
              <h3 class="text-sm font-semibold text-gray-600 dark:text-slate-300 uppercase tracking-wide mb-3">Pengaturan</h3>
              
              <!-- Language Toggle -->
              <div class="mb-4">
                <div class="flex items-center justify-between bg-gray-50/90 dark:bg-black rounded-xl p-3 border border-gray-200/80 dark:border-gray-600 shadow-inner">
                  <div class="flex items-center">
                  ...
                  <div class="flex bg-white/90 dark:bg-black rounded-lg p-1 shadow-sm">
                    <button 
                      @click="toggleLanguage('id'); onCloseMobileMenu()" 
                      class="px-3 py-1 text-xs font-semibold rounded-md transition-all duration-300"
                      :class="currentLanguage === 'id' ? 'bg-white text-black shadow-md ring-1 ring-gray-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100/80 dark:hover:bg-gray-800'"
                    >
                      ID
                    </button>
                    <button 
                      ...
                      class="px-3 py-1 text-xs font-semibold rounded-md transition-all duration-300"
                      :class="currentLanguage === 'en' ? 'bg-white text-black shadow-md ring-1 ring-gray-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100/80 dark:hover:bg-gray-800'"
                    >
                      EN
                    </button>
                  </div>
            ...
            <!-- Contact Section -->
            <div class="px-4 py-4 border-t border-gray-200/80 dark:border-slate-800/80">
              <h3 class="text-sm font-semibold text-gray-600 dark:text-slate-300 uppercase tracking-wide mb-3">Kontak</h3>
              <div class="space-y-3">
                <a
                  href="https://wa.me/6281234567890"
                  target="_blank"
                  class="flex items-center py-3 px-3 bg-white dark:bg-black border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 rounded-xl transition-all duration-300 group shadow-md"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-green-500 group-hover:text-green-600 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a
                  href="mailto:support@jasapembayaran.com"
                  class="flex items-center py-3 px-3 bg-white dark:bg-black border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 rounded-xl transition-all duration-300 group shadow-md"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-orange-500 group-hover:text-orange-600 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Main Content - Zero gap spacing -->
    <main class="flex-1 banner-slide-container dark-main-container"
          :class="colorMode.value === 'dark' ? 'dark-mode-main' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'"
          :style="{ marginTop: '0', paddingTop: isMobile ? '0' : '4.25rem' }">
      <div :class="['w-full mx-auto lg:max-w-7xl banner-content-wrapper', isBlogDetail ? 'px-2 md:px-4 lg:px-6' : 'px-0 md:px-0 lg:px-0']"
           style="margin-top: 0;">
        <NuxtPage />
      </div>
    </main>
...
// import SmartSlideMenu from '../../components/SmartSlideMenu.vue'
...
async function handleSmartSearch() {
  ...
  try {
    isSearchingSmart.value = true
    // Arahkan ke halaman pencarian artikel global (misalnya /blog/search?q=...)
    await router.push({
      path: '/blog/search',
      query: { q }
    })
...
.header-nav .nav-link { color: #1e293b !important; }
.header-nav .nav-link:hover { color: #3b82f6 !important; }
.header-nav .nav-link:focus-visible { color: #3b82f6 !important; }
.header-nav .nav-link.is-active { color: #1d4ed8 !important; }
